...
| permission_zombie | 36 |
| role_phantom | 5 |
| role_unused | 9 |
| screen_key_dead | 4 |
| screen_key_phantom | 14 |
...
| KMP    | contratos | 70 |
| Seed   | resources | 33 |
| Seed   | permissions | 104 |
| Seed   | roles | 12 |
| Seed   | role_permissions | 428 |
| Seed   | resource_screens | 63 |
| Seed   | screen_instances | 75 |
...
| warning | FE_ONLY | attendance:update | FE infiere permiso "attendance:update" (resource="attendance" action="update"): el resource existe en el seed pero la acción no está declarada en iam.permissions. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/AttendanceBatchContract.kt:11, EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/AttendanceListContract.kt:17, EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/AttendanceSummaryContract.kt:12 |
...
| warning | FE_ONLY | system_settings:update | FE infiere permiso "system_settings:update" (resource="system_settings" action="update"): el resource existe en el seed pero la acción no está declarada en iam.permissions. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/SystemSettingsContract.kt:28 |
...
| warning | BE_ONLY | guardian_relations:manage | Permiso "guardian_relations:manage" está asignado a algún role_permission pero ningún composable KMP ni slot_data lo consume. Revisión humana: posible uso interno backend. |  |
| warning | BE_ONLY | guardian_relations:request | Permiso "guardian_relations:request" está asignado a algún role_permission pero ningún composable KMP ni slot_data lo consume. Revisión humana: posible uso interno backend. |  |
| warning | BE_ONLY | materials:create | Permiso "materials:create" está asignado a algún role_permission pero ningún composable KMP ni slot_data lo consume. Revisión humana: posible uso interno backend. |  |
...
| warning | BE_ONLY | materials:update | Permiso "materials:update" está asignado a algún role_permission pero ningún composable KMP ni slot_data lo consume. Revisión humana: posible uso interno backend. |  |
...
| warning | BE_ONLY | screen_instances:create | Permiso "screen_instances:create" está asignado a algún role_permission pero ningún composable KMP ni slot_data lo consume. Revisión humana: posible uso interno backend. |  |
| warning | BE_ONLY | screen_instances:delete | Permiso "screen_instances:delete" está asignado a algún role_permission pero ningún composable KMP ni slot_data lo consume. Revisión humana: posible uso interno backend. |  |
| warning | BE_ONLY | screen_instances:read | Permiso "screen_instances:read" está asignado a algún role_permission pero ningún composable KMP ni slot_data lo consume. Revisión humana: posible uso interno backend. |  |
| warning | BE_ONLY | screen_instances:update | Permiso "screen_instances:update" está asignado a algún role_permission pero ningún composable KMP ni slot_data lo consume. Revisión humana: posible uso interno backend. |  |
...
| warning | BE_ONLY | screen_templates:read | Permiso "screen_templates:read" está asignado a algún role_permission pero ningún composable KMP ni slot_data lo consume. Revisión humana: posible uso interno backend. |  |
...
| warning | BE_ONLY | child-progress | El seed declara resource_screens.screen_key "child-progress" pero ningún composable KMP lo implementa. |  |
| warning | BE_ONLY | children-list | El seed declara resource_screens.screen_key "children-list" pero ningún composable KMP lo implementa. |  |
| warning | BE_ONLY | material-detail | El seed declara resource_screens.screen_key "material-detail" pero ningún composable KMP lo implementa. |  |
...
| Severidad | Dirección | Identificador | Detalle | Evidencia |
|-----------|-----------|---------------|---------|-----------|
| error | FE_ONLY | app-login | El frontend declara screenKey "app-login" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/LoginContract.kt:15 |
| error | FE_ONLY | app-settings | El frontend declara screenKey "app-settings" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/SettingsContract.kt:13 |
| error | FE_ONLY | assessment-assignment | El frontend declara screenKey "assessment-assignment" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/AssessmentAssignmentContract.kt:15 |
| error | FE_ONLY | assessment-modality | El frontend declara screenKey "assessment-modality" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/AssessmentModalityContract.kt:12 |
| error | FE_ONLY | assessment-review-dashboard | El frontend declara screenKey "assessment-review-dashboard" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/AssessmentReviewDashboardContract.kt:19 |
| error | FE_ONLY | assigned-assessments-list | El frontend declara screenKey "assigned-assessments-list" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/AssignedAssessmentsListContract.kt:17 |
| error | FE_ONLY | attempt-review-detail | El frontend declara screenKey "attempt-review-detail" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/AttemptReviewDetailContract.kt:10 |
...
| error | FE_ONLY | membership-add | El frontend declara screenKey "membership-add" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/MembershipAddContract.kt:16 |
| error | FE_ONLY | school-concepts-form | El frontend declara screenKey "school-concepts-form" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/SchoolConceptsFormContract.kt:10 |
| error | FE_ONLY | school-concepts-list | El frontend declara screenKey "school-concepts-list" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/SchoolConceptsListContract.kt:12 |
| error | FE_ONLY | user-roles | El frontend declara screenKey "user-roles" pero el seed de producción no tiene ningún resource_screens.screen_key con ese valor. | EduUI/edugo-ui-kmp/kmp-screens/src/commonMain/kotlin/com/edugo/kmp/screens/dynamic/contracts/UserRolesContract.kt:16 |
