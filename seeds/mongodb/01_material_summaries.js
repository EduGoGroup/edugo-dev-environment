...
db.material_summaries.insertMany([
  // Física Cuántica
  {
    ...
    summary:
      "Este material introduce los conceptos fundamentales de la física cuántica, incluyendo la dualidad onda-partícula y el principio de incertidumbre de Heisenberg. Se explora cómo las partículas subatómicas exhiben comportamientos que desafían nuestra intuición clásica.",
    key_points: [
  ...
  // Mecánica Newtoniana
  {
    ...
    summary:
      "Material completo sobre las tres leyes del movimiento de Newton. Incluye explicaciones detalladas con ejemplos cotidianos y ejercicios prácticos para aplicar cada ley.",
    key_points: [
  ...
  // Álgebra Lineal
  {
    ...
    summary:
      "Guía completa de álgebra lineal enfocada en matrices y determinantes. Cubre operaciones básicas, propiedades y aplicaciones en sistemas de ecuaciones lineales.",
    key_points: [
  ...
  // Cálculo Diferencial
  {
    ...
    summary:
      "Introducción al cálculo diferencial cubriendo límites, continuidad y derivadas. Material incluye reglas de derivación y aplicaciones en problemas de optimización.",
    key_points: [
  ...
  // Historia de Chile
  {
    ...
    summary:
      "Recorrido por los eventos más significativos del siglo XX en Chile, desde la cuestión social hasta el retorno a la democracia, pasando por los gobiernos radicales y el período de dictadura.",
    key_points: [
  ...
  // Biología Celular
  {
    ...
    summary:
      "Estudio detallado de la célula como unidad básica de la vida. Cubre la estructura celular, organelos y sus funciones, diferenciando entre células procariotas y eucariotas.",
    key_points: [
